...
const getInitialMessages = (year) => [
  {
    ...
    {
     "description_series":  "Crónica enfocada a las series del año ${year} de al menos 320 palabras".
     "description_movies":  "Crónica enfocada a las películas del año ${year} de al menos 320 palabras".
    }
    `,
  },
];
